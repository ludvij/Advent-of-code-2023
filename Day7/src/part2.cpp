...
public:
		...
		: value(bid)
	{
		...
		for(size_t i = 0; i < 5; i++) {
			const char c = hand[i];
			switch(c) {
				case 'J': cards[i] =  0; break;
				case '2': cards[i] =  1; break;
				case '3': cards[i] =  2; break;
				case '4': cards[i] =  3; break;
				case '5': cards[i] =  4; break;
				case '6': cards[i] =  5; break;
				case '7': cards[i] =  6; break;
				case '8': cards[i] =  7; break;
				case '9': cards[i] =  8; break;
				case 'T': cards[i] =  9; break;
